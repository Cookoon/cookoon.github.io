  ...
  <div>
    ...
    <Banner>
      ...
      <a
        ...
        className="btn btn-md bg-white px-5 mb-4"
        target="_blank"
    ...
    <div className="container text-center">
      ...
      <div className="row">
        ...
        <div className="col-md px-4 d-flex flex-column justify-content-between align-items-center">
          <div>
            <i className="co co-success text-primary fa-5x" aria-hidden="true" />
            <h2 className="h3 font-weight-normal my-4">Le rentabiliser simplement</h2>
          </div>
          <p className="text-justify">
        ...
        <div className="col-md px-4 pb-4 d-flex flex-column justify-content-between align-items-center">
          <div>
            <i className="co co-concierge text-primary fa-5x" aria-hidden="true" />
        ...
        <div className="row">
          ...
          <div className="col-md">
            <div className="d-flex flex-column flex-md-row justify-content-beetween align-items-center">
              <i className="co co-concierge text-primary mr-0 mr-md-3 fa-3x" aria-hidden="true" />
            ...
            <div className="d-flex flex-column flex-md-row justify-content-beetween align-items-center">
              <i className="co co-notifications text-primary mr-0 mr-md-3 fa-3x" aria-hidden="true" />
              <p className='mt-2 mb-md-0 '>
            ...
            <div className="d-flex flex-column flex-md-row justify-content-beetween align-items-center">
              <i className="co co-success text-primary mr-0 mr-md-3 fa-3x" aria-hidden="true" />
              <p className='mt-2 mb-md-0 '>
